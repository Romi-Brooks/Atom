...
public:
    ...
    Entity(Entity&& other) noexcept
        : texture_(std::move(other.texture_)), radius_(other.radius_), color_(other.color_), position_(other.position_),
          hp_(other.hp_), attack_(other.attack_), move_speed_(other.move_speed_),
