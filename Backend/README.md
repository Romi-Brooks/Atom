...
- `Registry/` stores backend and audio decoder factories; the runtime registers engine default decoders (e.g. `.mp3` → the minimp3 decoder) on every decoder registry install.
