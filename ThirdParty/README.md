...
Atom tracks third-party source code as pinned Git submodules. CMake exposes all
dependencies through [`ThirdParty/CMakeLists.txt`](CMakeLists.txt) with the
...
| stb | `Atom_3rd_Stb` | Image decoding and trusted font rasterization | `https://github.com/nothings/stb.git` | `2c980bb59875b0d32144a71867fbdebb2f77cd20` |
